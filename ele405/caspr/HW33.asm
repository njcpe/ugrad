...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
HASH:	ldi	r5, 0		;set init counters
	and	r7, r5		;set init counters
	ldi	r2, 16		;set init counters
sch1:	ldixi	r0, r5, m512	;r0 = m512(r5), r5++
	stixi	r7, r0, buffer	;buffer(r7) = r0, r7++
	adi	r2, 0xFFFF
	jnz	sch1
...
sch2:	;mov	r1, r7
	...
	;ldr	r4, r1		;r4=W(t-16)
	ldi	r1, 0xFFF0	;t-16
	ldix	r4, r1, buffer	;r4=W(t-16)

	add	r4, r0		;r4=sig1(W(t-15))+W(t-16)
	add	r3, r4		;r3=sig1(W(t-2))+W(t-7)+sig1(W(t-15))+W(t-16)
	;str	r7, r3
	;adi	r7, 1
