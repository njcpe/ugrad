...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	ldi	r1, gray	;get COLOR
	ldm	r2, gaddr	;get GADDR		
	str	r2, r1
	pop	r2
	pop	r1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;outputs: draw line between (x1,y1) and (x2,y2)
...
lin0:	ldm	r0, y1		;r0=y1
	ldm	r2, y2		;r2=y2
	sub	r2, r0		;r2=y2-y1
	jz	hln0		;horizontal line subroutine
	mul	r2, r2		;r2=r2**2
	ldm	r0, x1		;r0=x1
	ldm	r1, x2		;r1=x2
	sub	r1, r0		;r1=x2-x1
	jz	vln0		;vertical line subroutine
	mul	r1, r1		;r1=r1**2
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	mov	r5,r2
	pix	r4, r5	
	stm	gaddr, r5	;save to GADDR
	ldm	r4, color	;get COLOR
	ldm	r5, gaddr	;get GADDR		
	str	r5, r4
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	mov	r4, r1
	mov	r1, r2
...
next0:	stm	error, r4	;save back error
	adi	r1, 0x0001	;x=x+1
	ldm	r4, x2
	sub 	r4, r1
	jnz	lp40
