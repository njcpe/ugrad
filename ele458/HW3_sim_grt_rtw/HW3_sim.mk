###########################################################################
## Makefile generated for Simulink model 'HW3_sim'. 
## 
## Makefile     : HW3_sim.mk
## Generated on : Thu Mar 08 14:41:33 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\HW3_sim.exe
...
MODELREF_LINK_RSPFILE_NAME = HW3_sim_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = HW3_sim_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\HW3_sim.exe
...
INCLUDES_BUILDINFO = $(START_DIR);$(START_DIR)\HW3_sim_grt_rtw;$(START_DIR)\HW3;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=HW3_sim -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\HW3_sim_grt_rtw\HW3_sim.c $(START_DIR)\HW3_sim_grt_rtw\HW3_sim_data.c $(START_DIR)\HW3_sim_grt_rtw\rtGetInf.c $(START_DIR)\HW3_sim_grt_rtw\rtGetNaN.c $(START_DIR)\HW3_sim_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = HW3_sim.obj HW3_sim_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\HW3_sim_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\HW3_sim_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
